...
import registerBg from "../assets/bg-login.jpg"; // Đảm bảo file này có trong assets
...
const Register = ({ theme }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="mb-6 text-3xl font-bold text-center">Đăng Ký</h2>
        ...
        <div className="flex items-center justify-center mb-4">
          ...
          <span className="text-xs uppercase text-gray-500 mx-2">
            Hoặc
          </span>
          <span className="border-b w-1/5 lg:w-1/4"></span>
        </div>
